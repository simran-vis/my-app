...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Health Services", path: "/healthServices" },
    { name: "About", path: "/about" },
    { name: "Contact", path: "/contact" },
  ];

 return (
  <nav className="bg-white shadow-md sticky top-[48px] z-40 transition-all duration-300">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* 🔍 Search Bar (desktop) */}
      {showSearch && (
        <div className="hidden md:block absolute right-1/2 translate-x-1/2 top-[72px] w-1/2 animate-fadeIn">
          <div className="relative">
            <Search className="absolute left-3 top-3 text-gray-400 h-5 w-5" />
            <input
              type="text"
